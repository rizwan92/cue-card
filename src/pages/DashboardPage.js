        ...
        <div className="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header" style={{height:'100vh'}}>
          <header className="demo-header mdl-layout__header mdl-color--teal-300 mdl-color-text--black-600">
            <div className="mdl-layout__header-row">
              ...
              <button  id="myheader1" className="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon" >
                <i className="material-icons">more_vert</i>
              </button>
              <ul className="mdl-menu mdl-js-menu mdl-js-ripple-effect mdl-menu--bottom-right" htmlFor="hdrbtn1">
                <li className="mdl-menu__item" onClick={()=>{}}>Reload</li>
                <li className="mdl-menu__item">Contact</li>
                <li className="mdl-menu__item" onClick={()=>console.log('logout')}>Logout</li>
              </ul>
            </div>
          </header>
          <div className="demo-drawer mdl-layout__drawer mdl-color--white-grey-900 mdl-color-text--black-grey-50">
            <header className="demo-drawer-header mdl-color--teal-300 mdl-color-text--black-600" >
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9zOF8VxM6oNgGrfW1832Wpq-gRpuXUvGorYwpjXwUoBmz2MNV" className="demo-avatar" alt="something"/>
            ...
            <nav className="demo-navigation mdl-navigation mdl-color--black-grey-800">
              ...
              <NavLink className="mdl-navigation__link" to="/dashboard"><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i>Home</NavLink>
              <NavLink className="mdl-navigation__link" to="/dashboard/user"><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">local_offer</i>Users</NavLink>
              <NavLink className="mdl-navigation__link" to="/dashboard/card"><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>Card</NavLink>
          ...
          <main className="mdl-layout__content mdl-color--grey-100">
            ...
            <Route exact path="/dashboard"       render={props =><Dashboard {...props} search={this.state.search} />} />
            <Route exact path="/dashboard/home"  render={props =><Dashboard {...props} search={this.state.search} />} />
            <Route exact path="/dashboard/user"  render={props =><UserPage {...props} search={this.state.search} />} />
            <Route exact path="/dashboard/card"  render={props =><CardPage {...props} search={this.state.search} />} />
